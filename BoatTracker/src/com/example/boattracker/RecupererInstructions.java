 ...
 * un thread différent. L'Asynctask RecupererInstructions permet de récuperer 		*
 * dans la BDD du serveur les paramètres de fonctionnement (activation GPS, 		*
 * activation de l'emission sonore, changement de la fréquence d'émission) lorsque 	*
